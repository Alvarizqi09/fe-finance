...
const AuthLayout = ({ children }) => {
  return (
    <div className="flex min-h-screen w-full overflow-hidden">
      ...
      {/* Right Side - Graphics */}
      <div className="hidden md:flex md:w-[40%] bg-gradient-to-br from-emerald-100/80 to-teal-100/80 dark:bg-gradient-to-br dark:from-gray-800 dark:to-gray-900 backdrop-blur-xl overflow-hidden p-6 lg:p-8 relative flex-col items-center justify-start">
        {/* Decorative Elements */}
        ...
        {/* Stats Card - Top */}
        <div className="relative z-20 w-full max-w-sm mt-6">
          <StatsInfoCard
            icon={
        ...
        {/* SVG Background Illustration - Bottom */}
        <div className="relative z-10 w-full flex-1 flex items-end justify-center pb-6 px-4">
