...
const AuthLayout = ({ children }) => {
  return (
    <div className="flex min-h-screen">
      {/* Left Side - Form */}
      <div className="w-screen md:w-[60vw] px-8 md:px-12 py-6 md:py-8 flex flex-col bg-gradient-to-br from-emerald-50/90 to-teal-50/90 dark:from-gray-800 dark:to-gray-900">
      ...
      {/* Right Side - Graphics */}
      <div className="hidden md:block w-[40vw] bg-gradient-to-br from-emerald-100/80 to-teal-100/80 dark:bg-gradient-to-br dark:from-gray-800 dark:to-gray-900 backdrop-blur-xl overflow-hidden p-8 relative">
        {/* Decorative Elements */}
